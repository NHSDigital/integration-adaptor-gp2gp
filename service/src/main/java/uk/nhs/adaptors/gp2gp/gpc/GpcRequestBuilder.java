...
public class GpcRequestBuilder {
    ...
    public HttpPost buildGStructuredRecordRequest(Parameters parameters) {
        HttpPost httpPost = new HttpPost(gpcConfiguration.getUrl() + gpcConfiguration.getEndpoint());
//        StringEntity se = new StringEntity("charset","UTF-8");
//        se.setContentType("application/fhir+json");
//        httpPost.setEntity(se);
        httpPost.addHeader("Ssp-From", gpcConfiguration.getSspFrom());
        httpPost.addHeader("Ssp-To", gpcConfiguration.getSspTo());
        httpPost.addHeader("Ssp-InteractionID", gpcConfiguration.getSspInteractionID());
        ...
        httpPost.addHeader("Authorization", "Bearer " + gpcTokenBuilder.buildToken());
