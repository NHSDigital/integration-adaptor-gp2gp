...
public class AppConstants {
    ...
    public static final String ERROR_MESSAGE_PLACEHOLDER = "ERROR_MESSAGE_PLACEHOLDER_ID=";
    public static final String FILENAME_PLACEHOLDER = "FILENAME_PLACEHOLDER_ID=";
