...
public class AllergyStructureMapper {
    ...
    public String mapAllergyIntoleranceToAllergyStructure(AllergyIntolerance allergyIntolerance) {
        ...
        messageContext.getAgentReference()
            ...
            .ifPresent(ref -> allergyStructureTemplateParameters
                .recorder(participantMapper.mapToParticipant(ref, "AUT"))
                .asserter(participantMapper.mapToParticipant(ref, "PRF")));
