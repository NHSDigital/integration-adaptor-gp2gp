...
public class IdMapperTest {
    ...
    private final static String NON_UUID_ID = "THIS-IS-NOT-A-UUID";
    ...
    // Is this even a real use case, it seems pretty unfeasible that this would ever occur.
    // In the event that two UUIDs are the same for different resources, this would fail
    // as the GUID would be re-used and a new one not generated.
    // If this is a real world example, we would need to account for that in the `getOrNew` method.
    @Test
