...
//        var expectedOutput = ResourceTestFileUtils.getFileContent(outputXml);
        ...
        DiagnosticReportMapper diagnosticReportMapper = new DiagnosticReportMapper(messageContext);

        String outputMessage = diagnosticReportMapper.mapDiagnosticReportToCompoundStatement(diagnosticReport, false);
