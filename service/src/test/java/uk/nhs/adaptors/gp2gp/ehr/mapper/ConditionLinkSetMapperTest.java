...
public class ConditionLinkSetMapperTest {
    ...
    private static final String OUTPUT_XML_WITH_GENERATED_PROBLEM_WITH_NESTED = EXPECTED_OUTPUT_LINKSET + "3.xml";
    ...
    private static Stream<Arguments> testArguments() {
        return Stream.of(
            ...
            Arguments.of(INPUT_JSON_NO_ACTUAL_PROBLEM, OUTPUT_XML_WITH_GENERATED_PROBLEM_WITH_NESTED, true),
