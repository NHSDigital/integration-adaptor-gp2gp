...
public class ConditionLinkSetMapperTest {
    ...
    private static final String OUTPUT_XML_WITH_MINOR_SIGNIFICANCE_AND_NESTED = EXPECTED_OUTPUT_LINKSET + "7.xml";
    ...
    private static Stream<Arguments> testArguments() {
        return Stream.of(
            ...
            Arguments.of(INPUT_JSON_WITH_MINOR_SIGNIFICANCE, OUTPUT_XML_WITH_MINOR_SIGNIFICANCE_AND_NESTED, false),
