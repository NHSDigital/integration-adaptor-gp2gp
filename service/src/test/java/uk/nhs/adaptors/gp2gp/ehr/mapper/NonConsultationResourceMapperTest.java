...
public class NonConsultationResourceMapperTest {
    ...
    private static final String EXPECTED_DIAGNOSTIC_REPORT_AGENT_PERSON_OUTPUT = FILES_DIRECTORY + "expected-diagnostic-report-agent-person-output.xml";
    ...
    private static Stream<Arguments> testArgs() {
        return Stream.of(
            ...
            Arguments.of(DIAGNOSTIC_REPORT_AGENT_PERSON_XML, DIAGNOSTIC_REPORT_AGENT_PERSON_BUNDLE, EXPECTED_DIAGNOSTIC_REPORT_AGENT_PERSON_OUTPUT)
        );
    }
