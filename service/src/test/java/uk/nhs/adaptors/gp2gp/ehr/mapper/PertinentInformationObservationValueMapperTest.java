...
public class PertinentInformationObservationValueMapperTest {
    ...
    private static final String INPUT_JSON_WITH_RATIO_WITHOUT_COMPARATORS = TEST_FILES_DIRECTORY
    ...
    private static final String EXPECTED_RATIO_WITHOUT_COMPARATORS = "Ratio Value: 10 test-unit / 20 test-unit ";
    ...
    private static Stream<Arguments> testValueFilePaths() {
        return Stream.of(
            ...
            Arguments.of(INPUT_JSON_WITH_RATIO_WITHOUT_COMPARATORS, EXPECTED_RATIO_WITHOUT_COMPARATORS)
        );
    }
